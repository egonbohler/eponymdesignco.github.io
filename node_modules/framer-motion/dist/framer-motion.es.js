import { useRef, useEffect, memo, forwardRef, createContext, useMemo, useContext, createElement, Fragment, useCallback, useLayoutEffect, useState, cloneElement, Children, isValidElement } from 'react';
...
var Position = {
    key: "position",
    shouldRender: function (props) {
        return typeof window !== "undefined" && !!props.positionTransition;
    },
    Component: makeHookComponent(function (_a) {
